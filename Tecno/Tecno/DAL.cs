    ...
    public class DAL
    {
        ...
        public DAL()
        {
           // _SqlConn = new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = C:\Users\119190\Desktop\Tecno\Tecno\bin\Debug\Projeto.mdf; Integrated Security = True; Connect Timeout = 30");
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename="+ System.Windows.Forms.Application.StartupPath + @"\Projeto.mdf;Integrated Security=True;Connect Timeout=30"  );
        }
